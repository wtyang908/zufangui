<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="租房状态" align="center" prop="isHistory" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="yes：已退租，no：没退租" prop="isHistory">
          <el-input v-model="form.isHistory" placeholder="请输入yes：已退租，no：没退租" />
        </el-form-item>
        <el-form-item label="价格" prop="price">
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder,getCheckIdNameAndDate } from "@/api/system/order";
