  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="回复用户id" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入回复用户id" />
        </el-form-item>
        <el-form-item label="房屋id" prop="houseId">
        ...
        <el-form-item label="被回复用户id" prop="toUserId">
          <el-input v-model="form.toUserId" placeholder="请输入被回复用户id" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除评论回复编号为"' + ids + '"的数据项？').then(function() {
        return delReply(ids);
      }).then(() => {
        this.getList();
